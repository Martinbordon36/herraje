...
const FacturaView = () => {
  ...
  useEffect(() => {
    const fetchCliente = async () => {
      ...
      try {
        const response = await fetch(`http://vps-1915951-x.dattaweb.com:8090/api/v1/cliente/${idCliente}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
          },
          ...
          <div className="factura-client-info">
            <div className="factura-client-info-header">
              ...
              <div className="container2">
                ...
                <p><strong>Vendedor: {factura.vendedor}</strong>  </p>
              </div>
            </div>
          </div>
        </section>
